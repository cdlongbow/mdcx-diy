...
| `Pillow` | ==11.3.0 | 图片处理 |
| `opencv-contrib-python-headless` | ==4.13.0.92 | 人脸裁剪（无 GUI 版本） |
| `av` | >=15.0.0 | 视频处理 |
| `Jinja2` | >=3.1.6 | 模板引擎 |
...
| `pytest-cov` | >=6.2.1 | 测试覆盖率统计 |
| `ruff` | >=0.15.0,<0.16.0 | 代码检查和格式化 |
| `pre-commit` | >=4.2.0 | Git Hooks 管理 |
| `pyinstaller` | >=6.14.2 | 打包可执行文件 |
| `rich` | >=14.1.0 | 终端美化输出 |
| `typer` | >=0.16.0 | CLI 框架 |
| `types-lxml` | >=2025.3.30 | lxml 类型提示 |
