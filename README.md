...
1. 进入 GitHub Releases 下载对应平台的程序包
2. 首次启动后先在界面里设置刮削目录、下载选项和常用网站
3. 先用 1 到 3 个样例文件试跑，确认 NFO、封面和命名结果符合预期，再批量处理

### 遇到问题先看哪里

- 运行日志：程序会在日志目录自动生成日志文件
- 配置文档：`docs/README.md`
- 常见问题：`docs/FAQ.md`
...
**TMDB 集成**
- 🎬 TMDB API 查询和批量获取（Excel 持久化缓存，避免重复查询）
- 🌐 多语言信息获取
- 🔒 令牌桶限流器（3.5 req/s，突发 10）
- 🚀 并发查询（并发数 3）
